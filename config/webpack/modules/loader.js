...
module.exports = (dev) => {
        ...
        use: [
          {
            ...
            query: {
              limit: 2000,
              publicPath: '../../',
              name: 'source/images/[name]-[hash:8].[ext]'
            }
          },
          {
        ...
        use: [
          {
            ...
            query: {
              limit: 1,
              publicPath: '../../',
              name: 'source/fonts/[name]-[hash:8].[ext]'
            }
          }
        ]
      }
  ...
  cssLoader(/\.(sass|scss)$/, 'sass-loader?includePaths[]='+ paths.resolve(process.cwd(), './node_modules/compass-mixins/lib'));
